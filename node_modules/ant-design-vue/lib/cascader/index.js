    ...
    flattenTree: function flattenTree(options, changeOnSelect, fieldNames) {
      ...
      options.forEach(function (option) {
        ...
        if (option[childrenName]) {
          flattenOptions = flattenOptions.concat(_this3.flattenTree(option[childrenName], changeOnSelect, fieldNames, path));
        }
      });
      ...
      if (filtered.length > 0) {
        return filtered.map(function (path) {
          ...
          return _ref3 = {
            ...
            path: path
          }, (0, _defineProperty3['default'])(_ref3, names.label, render({ inputValue: inputValue, path: path, prefixCls: prefixCls, names: names })), (0, _defineProperty3['default'])(_ref3, names.value, path.map(function (o) {
            return o[names.value];
          })), (0, _defineProperty3['default'])(_ref3, 'disabled', path.some(function (o) {
            return !!o.disabled;
          })), _ref3;
        });
      }
      return [(_ref4 = {}, (0, _defineProperty3['default'])(_ref4, names.label, notFoundContent), (0, _defineProperty3['default'])(_ref4, names.value, 'ANT_CASCADER_NOT_FOUND'), (0, _defineProperty3['default'])(_ref4, 'disabled', true), _ref4)];
    },
