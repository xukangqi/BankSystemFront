...
var TreeNode = {
  ...
  methods: {
    ...
    renderSwitcher: function renderSwitcher() {
      ...
      var switcherIcon = (0, _propsUtil.getComponentFromProp)(this, 'switcherIcon') || (0, _propsUtil.getComponentFromProp)(this.vcTree, 'switcherIcon');
      if (this.isLeaf2()) {
        return h(
          'span',
          { key: 'switcher', 'class': (0, _classnames2['default'])(prefixCls + '-switcher', prefixCls + '-switcher-noop') },
          [typeof switcherIcon === 'function' ? (0, _vnode.cloneElement)(switcherIcon, { props: (0, _extends3['default'])({}, this.$props, { isLeaf: true }) }) : switcherIcon]
        );
      }
      ...
      return h(
        ...
        { key: 'switcher', on: {
          ...
          'class': switcherCls },
        [typeof switcherIcon === 'function' ? (0, _vnode.cloneElement)(switcherIcon, { props: (0, _extends3['default'])({}, this.$props, { isLeaf: false }) }) : switcherIcon]
      );
    },
    ...
    renderSelector: function renderSelector(h) {
      ...
      if (showIcon) {
        ...
        $icon = currentIcon ? h(
          ...
          [typeof currentIcon === 'function' ? currentIcon(h, (0, _extends3['default'])({}, this.$props)) : currentIcon]
        ) : this.renderIcon();
