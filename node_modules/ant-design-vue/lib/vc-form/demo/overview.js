...
var Option = _antDesignVue.Select.Option; /* eslint react/no-multi-comp:0, no-console:0 */
...
var Email = {
  ...
  render: function render() {
    ...
    return h(
      ...
      [h('div', ['email sync validate']), h('div', [h('input', getFieldProps('email', { initialValue: '', rules: [{ type: 'email', message: h(
            'b',
            { key: 'err' },
            ['\u9519\u8BEF\u7684 email \u683C\u5F0F']
          ) }] }))]), h(
  ...
  render: function render() {
    ...
    return h(
      ...
      [h('div', [h(
        ...
        ['*']
      ), 'user async validate']), h('div', [h('input', getFieldProps('user', { initialValue: '', validateFirst: true, rules: [{ required: true }, { validator: this.userExists }] }))]), h(
        'div',
        { style: _styles.errorStyle },
  ...
  render: function render() {
    ...
    return h(
      ...
      [h('div', [h(
        ...
        [h(_antDesignVue.DatePicker, (0, _babelHelperVueJsxMergeProps2['default'])([{
          attrs: {
            placeholder: 'please select'
          }
...
var NumberInput = {
  ...
  render: function render() {
    ...
    return h(
      'div',
      { style: _styles.regionStyle },
      [h('div', ['number input']), h('div', [h('input', getFieldProps('number', { initialValue: '1', rules: [{ transform: toNumber, type: 'number' }] }))]), h(
        'div',
        { style: _styles.errorStyle },
        [errors ? errors.join(',') : null]
      )]
    ...
    return h(
      ...
      [h('h2', ['overview']), h(
        ...
        [h(User, {
          ...
          'div',
          { style: _styles.regionStyle },
          [h('div', ['normal required input']), h('div', [h('input', getFieldProps('normal', { initialValue: '', rules: [{ required: true }] }))]), h(
            'div',
            { style: _styles.errorStyle },
