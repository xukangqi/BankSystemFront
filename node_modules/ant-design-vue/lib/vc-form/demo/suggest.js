  ...
  render: function render() {
    ...
    return h(
      ...
      [h('div', ['custom select sync validate']), h('div', [h(
        ...
        (0, _propsUtil.mergeProps)({ props: { placeholder: 'please select', mode: 'combobox', filterOption: false }, style: { width: '200px' } }, getFieldProps('select', { change: this.onChange, rules: [{ type: 'email' }, { required: true }] })),
