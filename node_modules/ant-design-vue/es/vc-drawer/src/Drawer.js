...
var Drawer = {
  ...
  methods: {
    ...
    getChildToRender: function getChildToRender(open) {
      ...
      var wrapperClassname = classnames(prefixCls, (_classnames = {}, _defineProperty(_classnames, prefixCls + '-' + placement, true), _defineProperty(_classnames, prefixCls + '-open', open), _defineProperty(_classnames, wrapClassName, !!wrapClassName), _classnames));
