...
var TreeNode = {
  ...
  methods: {
    ...
    renderSwitcher: function renderSwitcher() {
      ...
      var switcherIcon = getComponentFromProp(this, 'switcherIcon') || getComponentFromProp(this.vcTree, 'switcherIcon');
      if (this.isLeaf2()) {
        return h(
          'span',
          { key: 'switcher', 'class': classNames(prefixCls + '-switcher', prefixCls + '-switcher-noop') },
          [typeof switcherIcon === 'function' ? cloneElement(switcherIcon, { props: _extends({}, this.$props, { isLeaf: true }) }) : switcherIcon]
        );
      }
      ...
      return h(
        ...
        { key: 'switcher', on: {
          ...
          'class': switcherCls },
        [typeof switcherIcon === 'function' ? cloneElement(switcherIcon, { props: _extends({}, this.$props, { isLeaf: false }) }) : switcherIcon]
      );
    },
    ...
    renderSelector: function renderSelector(h) {
      ...
      if (showIcon) {
        ...
        $icon = currentIcon ? h(
          ...
          [typeof currentIcon === 'function' ? currentIcon(h, _extends({}, this.$props)) : currentIcon]
        ) : this.renderIcon();
